        ...
        <div class="flex-container clear">
            <div class="tour-details-block">
                ...
                <div class="slideshow">
                    ...
                    <div class="slideshow-images-block">
                    </div>
                </div>
                ...
                <div class="tour-description-main-container">
                    ...
                    <div class="tour-programm-block">
                        <p id="tour-programm-title" class="tour-description">Программа тура</p>
                        <div class="tour-full-programm-block side-bar-menu">
                            <div class="tour-full-programm-day-blcok">
                                ...
                                <div class="tour-full-programm-desc-txt">
                                    <p class="tour-description-txt tour-full-programm-more-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                                        dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                                        ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                                        fugiat nulla pariatur.
                                        Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                ...
                <div class="side-bar-menu tour-details-side-bar-menu clear">
                    ...
                    <div class="select-value-container clear">
                        <div class="select-value-block">
                            <p class="select-value-desc">Взрослые</p>
                            <div class="select-value">
                                <div class="change-value-block subtract-value">-</div>
                                <span class="selected-value" id="adults">2</span>
                                <div class="change-value-block add-value">+</div>
                            </div>
                        </div>
                        <div class="select-value-block">
                            <p class="select-value-desc">Дети</p>
                            <div class="select-value">
                                <div class="change-value-block subtract-value">-</div>
                                <span class="selected-value" id="kids">1</span>
                                <div class="change-value-block add-value">+</div>
                            </div>
                        </div>
                    </div>
                    <div class="select-tour-date-container">
                        <p class="select-tour-date-title">Выберите день тура</p>
                        <div class="select-tour-date-block">
                            <div class="tour-date">
                                10.08.2019
                            </div>
                            <div class="tour-date">
